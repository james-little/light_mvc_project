...
class ErrorCode
{
    ...
    const ERROR_CACHE_NOT_SUPPORT_OPERATION = -154;
    // redis
    ...
    // batch
    const ERROR_BATCH = -800;
    const ERROR_BATCH_NOT_EXISTS = -801;
    const ERROR_BATCH_OUTPUT_FILE_NOT_EXISTS = -802;
    const ERROR_BATCH_VIEW_NOT_SUPPORT = -803;
    const ERROR_BATCH_VIEW_CONFIG_NOT_EXISTS = -804;
    const ERROR_BATCH_VIEW_FAILED = -805;
    // ------------------------- application----------------------------------
    // config
    ...
    const ERROR_REQUEST_NOT_SUPPORT = -1017;
    const ERROR_REQUEST_NOT_MATCH = -1018;
    // debug
    const ERROR_APP_DEBUG_CONFIG_FILE_NOT_EXIST = -1019;
    // controller & action
